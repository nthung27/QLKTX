...
<?php
    ...
    if ($searchTerm) {
        $sql = "SELECT * FROM sinhvien WHERE Hoten LIKE '%$searchTerm%' OR Masinhvien LIKE '%$searchTerm%' LIMIT $itemsPerPage OFFSET $offset";
        $countSql = "SELECT COUNT(*) AS total FROM sinhvien WHERE Hoten LIKE '%$searchTerm%' OR Masinhvien LIKE '%$searchTerm%'";
    } else {
        $sql = "SELECT * FROM sinhvien LIMIT $itemsPerPage OFFSET $offset";
        $countSql = "SELECT COUNT(*) AS total FROM sinhvien";
    }
